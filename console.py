...
hill_1 = Hill("Beinn a' Chlaidheimh", 913.96, "Highland")
hill_repo.save(hill_1)
hill_2 = Hill("Beinn Dearg", 913.7, "Highland")
hill_repo.save(hill_2)
hill_3 = Hill("Sgùrr nan Ceannaichean", 913.43, "Highland")
hill_repo.save(hill_3)
hill_4 = Hill("Sgùrr a' Choire-bheithe", 913.32, "Highland")
hill_repo.save(hill_4)
hill_5 = Hill("Beinn Bhreac", 912.44, "Perth and Kinross")
hill_repo.save(hill_5)
hill_6 = Hill("Leathad an Taobhain", 911.7, "Highland/Perth and Kinross")
hill_repo.save(hill_6)
hill_7 = Hill("The Fara", 911.4, "Highland")
hill_repo.save(hill_7)
hill_8 = Hill("Foinaven", 911.05, "Highland")
hill_repo.save(hill_8)
hill_9 = Hill("Beinn nan Oighreag", 909.6, "Perth and Kinross/Stirling")
